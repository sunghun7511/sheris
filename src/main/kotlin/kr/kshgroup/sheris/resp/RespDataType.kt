...
enum class RespDataType(
    val label: String,
    val minimumVersion: RespVersion,
    val category: RespDataCategory,
    val firstByte: Char
) {
    ...
    companion object {
        private val firstByteMap = entries.associateBy { it.firstByte }
        fun get(firstByte: Char): RespDataType {
            return firstByteMap[firstByte]
                ?: throw IllegalArgumentException("Unknown data type: $firstByte")
        }
    }
}
